...
module.exports = (env) => {
  ...
  const _output_filename_ = !env.legacy ? "[name].js" : "[name].legacy.js";
  const _chunk_filename_ = !env.legacy ? "module~[name].js" : "module~[name].legacy.js";
  const _chunk_filenameProd_ = !env.legacy
    ? "module~[name].[contenthash].js"
